		...
		<?php
			...
			$result=mysqli_query($conn,$sql); ?>
		  	<table class="basic_box">
				<tr>
					<th colspan="4"><p style="font-size: 28px; text-align: center; text-decoration: underline;">Remove MEAL</p></th>
				</tr>
				<tr>
					<th>Meal Type</th>
					<th>serving</th>
			...
			<table>
				<tr>
					<td style="text-align: left;"><b>Select meal type:</td>
					<td style="text-align: left;">
						<select name="rooms" required>
							<option value="">Select</option>
							
							<option value="Single bed">Githeri</option>
							<option value="Single">Beans</option>
							<option value="Single bed">Chapati</option>
							<option value="Double bed">Ugali</option>
							<option value="rice">Rice</option>
						</select>
					</td>
				</tr>
				<tr>
					<td style="text-align: left;">Enter number of meals to remove:</td>
