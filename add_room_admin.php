	...
	<div style="margin-left:25%;padding:1px 16px;height:1000px;">
		...
		-->
			...
			<table>
				...
				<tr>
				<td style="text-align: left;">Enter Name of Meal:<input type="text" id="meal" name="meal" ></td>
					<td style="text-align: left;">Enter Price:<input type="text"  name="price"  required></td>
				</tr>
